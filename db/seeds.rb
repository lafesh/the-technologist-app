...
Review.create([
    {title: "Anker Wireless Charger: Buy or Bust?", content: "Wireless charging is no longer a thing of the future. With wireless charging on the rise, it is imperitive to find a charger worth buying. While I was hesitant about buying a wireless charger at first, I am very satisfied with my decision to purchase. For my wireless charging needs, I decided to go with Anker's wireless charger. Not only is the charger inexpensive, but it has a slim design, making it easy to place in your home. Anker outfitted the charger with blue lights around its outer edge, making it easy for users to see when their phone is charging, and when it's ready to use. While I love my Anker wireless charger overall, I do wish that I could detach it from its cord to take on the road with me--it's simple design lends itself well to be a pocket-sized wireless charger. Overall, I'd recommend Anker's product to a friend; 10/10."},
